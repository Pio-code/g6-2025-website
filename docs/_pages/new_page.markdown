...
### aggiungere mappa di comparazione tra i due scenari con diversi gradi di contrazioene es espansione
...
### aggiungere mappa per raggurappamento di habitat
...
### aggiungere mappa per raggurappamento per ordine
